...
#error "Please define reduction type."
    ...
    vector<Root_> forward_omega_table =
        parameters.gpu_root_of_unity_table_generator(parameters.forward_root_of_unity_table);

    THROW_IF_CUDA_ERROR(cudaMemcpy(Forward_Omega_Table_Device, forward_omega_table.data(),
