...
int main(int argc, char* argv[])
{
              ...
              << std::endl;
    {
        ...
        GPU_NTT(InOut_Datas, Out_Datas, Inverse_Omega_Table_Device,
...

    {
        ...
        GPU_NTT_Inplace(InOut_Transpose_Datas, Inverse_Omega_Table_Device,
        ...
        GPU_NTT_Inplace(InOut_Normal_Datas, Inverse_Omega_Table_Device,
