            ...
            switch (cfg.n_power)
            {
                ...
                case 17:
                    ...
                    ForwardCore<<<dim3(16, 16, batch_size), dim3(32, 8),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 4, 4,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(1, 256, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 8, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    break;
                case 18:
                    ...
                    ForwardCore<<<dim3(32, 16, batch_size), dim3(16, 16),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 4, 5,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(1, 512, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 9, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    break;
                case 19:
                    ...
                    ForwardCore<<<dim3(32, 32, batch_size), dim3(16, 16),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 5, 5,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(1, 1024, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 10, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    break;
                case 20:
                    ...
                    ForwardCore<<<dim3(64, 32, batch_size), dim3(8, 32),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 5, 6,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(1, 2048, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 11, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    break;
                case 21:
                    ...
                    ForwardCore<<<dim3(64, 64, batch_size), dim3(8, 32),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 6, 6,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(1, 4096, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 12, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    break;
                case 22:
                    ...
                    ForwardCore<<<dim3(128, 64, batch_size), dim3(4, 64),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 6, 7,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(1, 8192, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 13, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                ...
                case 23:
                    ...
                    ForwardCore<<<dim3(128, 128, batch_size), dim3(4, 64),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 7, 7,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(1, 16384, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 14, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    break;
                case 24:
                    ForwardCore<<<dim3(16384, 1, batch_size), dim3(8, 64),
                        ...
                        device_in, device_out, root_of_unity_table, modulus, 9, 0, 7,
                        cfg.n_power, cfg.zero_padding, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(128, 128, batch_size), dim3(8, 64),
                                  1024 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 9, 7, 7,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                ...
                case 25:
                    ...
                    ForwardCore<<<dim3(256, 128, batch_size), dim3(4, 128),
                                  1024 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 9, 7, 8,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ///////////////////////////////////////////////////////////
                ...
                case 26:
                    ForwardCore<<<dim3(65536, 1, batch_size), dim3(4, 128),
                                  1024 * sizeof(Data), cfg.stream>>>(
                        device_in, device_out, root_of_unity_table, modulus, 9, 0, 8,
                        cfg.n_power, cfg.zero_padding, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(256, 256, batch_size), dim3(4, 128),
                                  1024 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 9, 8, 8,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ///////////////////////////////////////////////////////////
                ...
                case 27:
                    ...
                    ForwardCore<<<dim3(128, 2048, batch_size), dim3(4, 64),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 11, 7,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ///////////////////////////////////////////////////////////
                    ForwardCore_<<<dim3(262144, 1, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 18, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
#else
                    ...
                    ForwardCore<<<dim3(512, 256, batch_size), dim3(2, 256),
                                  1024 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 9, 8, 9,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ///////////////////////////////////////////////////////////
                ...
                case 28:
                    ...
                    ForwardCore<<<dim3(128, 4096, batch_size), dim3(4, 64),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 12, 7,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ///////////////////////////////////////////////////////////
                    ForwardCore_<<<dim3(524288, 1, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 19, 9,
                        cfg.n_power, false, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    break;
                    ...
                    ForwardCore<<<dim3(262144, 1, batch_size), dim3(2, 256),
                                  1024 * sizeof(Data), cfg.stream>>>(
                        device_in, device_out, root_of_unity_table, modulus, 9, 0, 9,
                        cfg.n_power, cfg.zero_padding, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ForwardCore<<<dim3(512, 512, batch_size), dim3(2, 256),
                                  1024 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 9, 9, 9,
                        cfg.n_power, false, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus));
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    ///////////////////////////////////////////////////////////
            ...
            switch (cfg.n_power)
            {
                case 12:
                    InverseCore<<<dim3(1, 8, batch_size), dim3(256, 1),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_in, device_out, root_of_unity_table, modulus, 8, 11, 3, 9,
                        cfg.n_power, cfg.rns_mod_inverse, false,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus), mod_count);
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    InverseCore<<<dim3(8, 1, batch_size), dim3(64, 4),
                                  512 * sizeof(Data), cfg.stream>>>(
                        device_out, device_out, root_of_unity_table, modulus, 8, 2, 0, 3,
                        cfg.n_power, cfg.rns_mod_inverse, true,
                        (cfg.reduction_poly == ReductionPolynomial::X_N_minus), mod_count);
                    THROW_IF_CUDA_ERROR(cudaGetLastError());
                    break;
                case 13:
